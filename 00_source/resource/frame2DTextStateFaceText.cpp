...
//	静的メンバ変数宣言
//************************************************************
CFrame2DTextStateFaceText::AFuncOffset CFrame2DTextStateFaceText::m_aFuncOffset[][SELECT_MAX] =	// オフセット取得関数リスト
{
	{ &CFrame2DTextStateFaceText::GetOffsetDownLeft, &CFrame2DTextStateFaceText::GetOffsetDownRight },	// 下部配置オフセット
};
...
//	移譲コンストラクタ (デフォルト)
//============================================================
CFrame2DTextStateFaceText::CFrame2DTextStateFaceText() : CFrame2DTextStateFaceText(VEC3_ZERO, VEC3_ZERO, VEC3_ZERO)
{
	// スタティックアサート
...
//	コンストラクタ (配置指定)
//============================================================
CFrame2DTextStateFaceText::CFrame2DTextStateFaceText(const VECTOR3& rOffsetText, const VECTOR3& rOffsetSelectL, const VECTOR3& rOffsetSelectR) : CFrame2DTextStateText(rOffsetText),
	m_sCutTextPath	(""),		// 現在テキストの保存パス
	m_pSoul			(nullptr),	// ソウルカーソル情報
	m_nCurSelect	(0)			// 現在の選択肢
{
...
//	テキスト変更処理
//============================================================
void CFrame2DTextStateFaceText::ChangeText(const ESelect select, const AText& rText)
{
	// 文字列を全て削除
...
//	プリセットオフセットの取得処理
//============================================================
VECTOR3 CFrame2DTextStateFaceText::GetPresetOffset(const ESelect select, const CFrame2D::EPreset preset)
{
	// プリセット範囲外エラー
...
//	文字送りの更新処理
//============================================================
void CFrame2DTextStateFaceText::UpdateScroll()
{
	if (IsTextEndScroll())
	{ // 本文の文字送りが終了した場合
...
//	選択の更新処理
//============================================================
void CFrame2DTextStateFaceText::UpdateSelect()
{
	// 選択肢操作
...
//	決定の更新処理
//============================================================
void CFrame2DTextStateFaceText::UpdateDecide()
{
	// 決定操作がされていない場合抜ける
...
//	選択肢の最大行数の取得処理
//============================================================
int CFrame2DTextStateFaceText::GetMaxSelectLine()
{
...
//	左下部配置オフセットの取得処理
//============================================================
VECTOR3 CFrame2DTextStateFaceText::GetOffsetDownLeft()
{
	// オフセットの計算
	VECTOR3 offset;
...
//	右下部配置オフセットの取得処理
//============================================================
VECTOR3 CFrame2DTextStateFaceText::GetOffsetDownRight()
{
	// オフセットの計算
	VECTOR3 offset;
