...
public:
	...
	CFrame2DTextStateFaceText(const VECTOR3& rOffsetText, const VECTOR3& rOffsetSelectL, const VECTOR3& rOffsetSelectR);
...
private:
	// エイリアス定義
	typedef VECTOR3(CFrame2DTextStateFaceText::*AFuncOffset)();	// オフセット取得関数ポインタ
