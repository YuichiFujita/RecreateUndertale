...
public:
	...
	void SetFrameSize(const D3DXVECTOR3& rSize)		{ m_pFrame->SetVec3Size(rSize); }		// フレーム大きさ設定
	...
	D3DXVECTOR3 GetFrameSize(void) const			{ return m_pFrame->GetVec3Size(); }		// フレーム大きさ取得
