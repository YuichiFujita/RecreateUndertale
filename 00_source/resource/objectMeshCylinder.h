...
public:
	...
	inline VECTOR3 GetVec3Position() const override	{ return m_meshCylinder.pos; }			// 位置取得
	inline VECTOR3 GetVec3Rotation() const override	{ return m_meshCylinder.rot; }			// 向き取得
	inline MATRIX* GetPtrMtxWorld() override		{ return &m_meshCylinder.mtxWorld; }	// マトリックスポインタ取得
	inline MATRIX GetMtxWorld() const override		{ return m_meshCylinder.mtxWorld; }		// マトリックス取得
	...
	inline float GetAlpha() const			{ return m_meshCylinder.col.a; }	// 透明度取得
	inline COLOR GetColor() const			{ return m_meshCylinder.col; }		// 色取得
	inline float GetRadius() const			{ return m_meshCylinder.fRadius; }	// 半径取得
	inline float GetHeight() const			{ return m_meshCylinder.fHeight; }	// 縦幅取得
	inline ETexDir GetTexDir() const		{ return m_meshCylinder.texDir; }	// テクスチャ方向取得
